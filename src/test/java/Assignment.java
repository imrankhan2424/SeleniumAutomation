...
public class Assignment {
    public static void main(String[] args) {
        ...
        driver.findElement(By.cssSelector("input[name='name']")).sendKeys("Imran");
        driver.findElement(By.cssSelector("input[name='email']")).sendKeys("Imran@gmail.com");
        ...
        driver.findElement(By.cssSelector("input[name='bday']")).sendKeys("02/10/1998");
